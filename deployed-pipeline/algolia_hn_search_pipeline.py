...
keywords = ["airbyte", "fivetran", "matillion", "meltano", "singer", "stitch"] # Specify your list of keywords here
...
def load_data_by_date():
	...
	data = algolia_hn_search(
		...
		# end_date=end_date,
		text="comment" # Change this to "story" to load only stories or to "comment" to load only comments
	)
